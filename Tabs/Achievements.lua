...
WHC.Achievements = {
    ...
    SPECIAL_DELIVERIES     = { id = 16,    icon = "inv_crate_03",                        itemId = "707004", itemLink = "", name = "Special Deliveries",     desc = "Reach level 60 without ever getting goods or money from player mail (simple letters, NPC, AH, and GM quest/items/gold allowed)." },
