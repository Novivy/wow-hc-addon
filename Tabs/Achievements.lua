...
WHC.Achievements = {
    ...
    RESTLESS               = { id = 131072, icon = "xp_icon",                             itemId = "707020", itemLink = "", name = "Restless",               desc = "Reach level 60 without ever gaining rested experience. Use '.restedxp' to toggle rested XP gain." },
