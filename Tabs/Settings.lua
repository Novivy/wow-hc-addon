...
function WHC.Tab_Settings(content)
    ...
    WHC_SETTINGS.onlyKillBoarsCheckbox = createSettingsCheckBox(scrollContent, string.format("[Time is Money] Achievement: Block auction house buying", WHC.Achievements.THAT_WHICH_HAS_NO_LIFE.name))
